	...
	<tr>
		<td style="" width="180">
			<table class="characterStats" cellspacing="0" style="">
				...
				<tr>
					...
					<td><input type="text" class="stat" placeholder="0" maxlength="4" readonly="readonly" /></td>
		...
		<td>
			<table class="characterStats" cellspacing="0" style="">
				...
				<tr>
					<td>
						<div class="left label">HP</div>
						<input type="text" class="left mld stat" id="hpMax" name="hpMax" placeholder="0" maxlength="4" />
						<input type="text" class="left mld stat" id="hpCurrent" name="hpCurrent" placeholder="0" maxlength="4" />
						<div class="left label" style="margin-left: 10px">OPP</div>
						<input type="text" class="left mld stat" id="oppMax" name="oppMax" placeholder="0" maxlength="4" />
						<input type="text" class="left mld stat" id="oppCurrent" name="oppCurrent" placeholder="0" maxlength="4" />
					</td>
				</tr>
				<tr>
					<td>
						<div class="left label">AC</div>
						<input type="text" class="left mld stat" maxlength="4" readonly="readonly" />
						<div class="left mld"> = 10</div>
						<div class="left mld"> + <input type="text" class="stat" id="armorAC" name="armorAC" placeholder="0" maxlength="4" /></div>
						<div class="left mld"> + <input type="text" class="stat" id="shieldAC" name="shieldAC" placeholder="0" maxlength="4" /></div>
						<div class="left mld"> + <input type="text" class="stat" id="sizeAC" name="sizeAC" placeholder="0" maxlength="4" /></div>
						<div class="left mld"> + <input type="text" class="stat" id="miscAC" name="miscAC" placeholder="0" maxlength="4" /></div>
				</tr>
				<tr class="labels" style="text-align: center;">
					<th></th>
					<th>Total</th>
